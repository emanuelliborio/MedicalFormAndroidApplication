 ...
 */
public class All_Patients_Daysheet_TableView extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_patients_daysheet_tableview);
        ...
        admin_id_string = id_receiver.getStringExtra("user_id");
        ...
        daysheet_table_layout = (TableLayout) findViewById(R.id.all_daysheet_table_Layout);
    ...
    private void BuildTable() {
        ...
        Cursor CR_Daysheet = DOP.getAllDaysheetPatientInformation(DOP);
